# Release Procedure for ados-helper

This document describes the process for creating and publishing a new release of ados-helper.

## Version Numbering

ados-helper follows [Semantic Versioning](https://semver.org/spec/v2.0.0.html):
